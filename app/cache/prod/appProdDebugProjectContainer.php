...
class appProdDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_FinanceiroMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_financeiro_8bf1da162ef326421c99a13a9a5830680c7abfd955a06a3c69aa2f56d644e2eb');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_LumaMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_luma_8bf1da162ef326421c99a13a9a5830680c7abfd955a06a3c69aa2f56d644e2eb');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_RhMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_rh_8bf1da162ef326421c99a13a9a5830680c7abfd955a06a3c69aa2f56d644e2eb');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_TroubleticketMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_troubleticket_8bf1da162ef326421c99a13a9a5830680c7abfd955a06a3c69aa2f56d644e2eb');
    ...
    {
        return $this->services['troubleticket.circuit_api'] = new \TroubleticketBundle\Api\TroubleticketCircuitApi(array('url' => 'http://dev.vogeltelecom.com:5001/vogel/web/rest/', 'limit' => 100));
    }
    ...
    {
        return $this->services['troubleticket.circuit_info_api'] = new \TroubleticketBundle\Api\TroubleticketCircuitInfoApi(array('url' => 'http://dev.vogeltelecom.com:5001/vogel/web/rest/', 'limit' => 100));
    }
    ...
    {
        return $this->services['troubleticket.client_api'] = new \TroubleticketBundle\Api\TroubleticketClientApi(array('url' => 'http://dev.vogeltelecom.com:5001/vogel/web/rest/', 'limit' => 100));
    }
    ...
    {
        return $this->services['troubleticket.colaborador_api'] = new \TroubleticketBundle\Api\ColaboradorApi(array('url' => 'http://dev.vogeltelecom.com:5001/vogel/web/rest/', 'limit' => 100));
    }
    ...
    {
        return $this->services['troubleticket.error_listener'] = new \TroubleticketBundle\EventListener\ErrorHandlerListener($this->get('templating'), 'prod');
    }
    ...
    {
        return $this->services['troubleticket.pop_api'] = new \TroubleticketBundle\Api\TroubleticketPopApi(array('url' => 'http://dev.vogeltelecom.com:5001/vogel/web/rest/', 'limit' => 100));
    }
    ...
    {
        return $this->services['troubleticket.provider_api'] = new \TroubleticketBundle\Api\TroubleticketProviderApi(array('url' => 'http://dev.vogeltelecom.com:5001/vogel/web/rest/', 'limit' => 100));
    }
